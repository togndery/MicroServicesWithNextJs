   ...
   public static void IntDb(WebApplication app){
    ...
    private static void SeedData(AuctionDbContext context)
    {
       ...
       if(context.Auctions.Any()){
        ...
        Console.WriteLine($"We have data in the table{context.Database.ProviderName.ToString()} no need to seed ");
        return;
       }

       var auctionions = new List<Auction>()
       {
             	    // 1 Ford GT
            new Auction
            {
